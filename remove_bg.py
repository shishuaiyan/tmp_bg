...
class RemoveBg:
    ...
    def remove_background_from_img_file(self, img_file_path, size="regular", new_file_name='no-bg.png'):
        """
    ...
    def remove_background_from_img_url(self, img_url, size="regular", new_file_name=None):
        """
        ...
        if new_file_name == None:
            new_file_name = 'removed_bg_' + img_url.split('/')[-1].split('.')[0] + '.png'
        self.__output_file__(response, new_file_name)
...
if __name__ == '__main__':
    api_key = 'LQV4wycjR6nNKT9n4hkLwoeU'
    remove_bg = RemoveBg(api_key, './error_log.txt')
    remove_bg.remove_background_from_img_file(r'C:\Users\Weilit\Documents\Tencent Files\328300834\FileRecv\MobileFile\img_01.jpg', 'hd', r'C:\Users\Weilit\Documents\Tencent Files\328300834\FileRecv\MobileFile\1.png')
